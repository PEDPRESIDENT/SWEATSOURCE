...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Sweat.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Sweat-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  sweat-qt [" + tr("command-line options") + "]                     " + "\n";
